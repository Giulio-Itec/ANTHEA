...
public partial class App : Application
{
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        {
            if (e.Args.Length >= 2 && e.Args[0] is "--smoke" or "--smoke-horizontal" or "--smoke-display")
            {
        ...
        MainWindow = window;
        if (e.Args.Length == 3 && e.Args[0] == "--smoke" || e.Args.Length == 2 && e.Args[0] is "--smoke-horizontal" or "--smoke-display")
        {
            ...
            async void RunSmoke(object? sender, EventArgs args)
            {
                ...
                try
                {
                    if (e.Args[0] == "--smoke-display") await window.SmokeDisplay(e.Args[1]);
