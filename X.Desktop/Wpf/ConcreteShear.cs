...
internal sealed partial class ConcreteWorkspace
{
    ...
    private void RefreshAutomaticShear()
    {
        ...
        try
        {
            ...
            shearAutomaticNote.Text = "Automatici dal wizard: bw minima; d dal baricentro delle barre di lembo, minimo fra i due versi; Asl minima dei due lembi. Per T: Vx usa lo spessore ala, Vy l’anima. Asl è geometrica: ancoraggio e disposizione resistente restano da verificare.";
        }
