...
public sealed partial class MaterialWindow
{
    ...
    UIElement BuildDetails(UIElement properties)
    {
        ...
        ntcOptions=Stack(
            ...
            Numeric("ntcCmin","Cmin pertinente · fck (facoltativo)","","MPa"),
            Text("Se vuoto: soglia Cmin della tabella C4.1.IV. Verificare la classe minima pertinente all'esposizione secondo UNI EN 206:2016; l'aumento di copriferro non sostituisce i requisiti della miscela.",12),
            ntcQuality);
