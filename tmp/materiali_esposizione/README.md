...
La versione aggiornata è in app-esposizione-menu; una finestra già aperta della vecchia versione va chiusa e riaperta tramite questo collegamento.
...
Sorgenti in src. Compila.cmd pubblica in app-esposizione-menu. Verifica.cmd esegue controlli numerici, aggiornamenti UI e acquisizioni a 1500/1200 px.
Esito: app-esposizione-menu/verifica.txt. Anteprime: app-esposizione-menu/anteprima-*.png.
...
Per la verifica sul monitor e sulla scala correnti: eseguire app-esposizione-menu\Materiali.exe --check-display. Il risultato viene scritto in app-esposizione-menu\verifica-schermo.txt. La prova non modifica l'ingrandimento di Windows.
