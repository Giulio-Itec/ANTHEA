...
{
    public static readonly string[] Moduli=["geo_palo_verticale","geo_micropalo_verticale","str_palo"];
    ...
    public static JsonObject NuovoFoglio(string module)
    {
        ...
        if(micro)
        {
            foreach(var (k,v) in J.Obj(("metodo_micropalo",BustamanteDoix.Versione),("tipo_iniezione",""),("profilo_chs",""),("pressione_iniezione",""),("inclinazione","0"),("inizio_aderenza","0"),("considera_punta",false),("percentuale_punta","0")))g[k]=v?.DeepClone();
        }
        return J.Obj(("generali",g),("efficienza",J.Obj(("metodo","Nessuna riduzione"),("numero_pali_x","1"),("numero_pali_y","1"),("interasse_x",""),("interasse_y",""),("eta_compressione","1"),("eta_trazione","1"))),("stratigrafie",new JsonArray(new JsonArray())),("visibilita_grafici",new JsonObject()));
    }
