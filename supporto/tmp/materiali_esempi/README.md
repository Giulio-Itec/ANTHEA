...
La versione aggiornata è in app-esempi; una finestra già aperta della vecchia versione va chiusa e riaperta tramite questo collegamento.
...
Sorgenti in src. Compila.cmd pubblica in app-esempi. Verifica.cmd esegue controlli numerici, aggiornamenti UI e acquisizioni a 1500/1200 px.
Esito: app-esempi/verifica.txt. Anteprime: app-esempi/anteprima-*.png.
...
Per la verifica sul monitor e sulla scala correnti: eseguire app-esempi\Materiali.exe --check-display. Il risultato viene scritto in app-esempi\verifica-schermo.txt. La prova non modifica l'ingrandimento di Windows.
