...
Path('supporto/tmp/validazione_ca/template_inventory.json').write_text(json.dumps(inv,indent=2))
...
'''
Path('supporto/tmp/validazione_ca/artifact.md').write_text(text,encoding='utf-8')
